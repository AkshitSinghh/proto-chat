...
const HomeBar = ({ setLoginRegisterToggle }) => {
  ...
  return (
    <div className="bg-accent h-[4rem] md:h-[3rem] w-full flex border-0 border-bottonBarAnimation md:border-b-2 pb-[2%] homeBar-shadow">
